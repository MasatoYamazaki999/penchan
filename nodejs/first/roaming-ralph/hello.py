...
from panda3d.core import CollideMask, CollisionBox, LPoint3f
...
global base, render, loader, taskMgr, globalClock, g_item
...
class RoamingRalphDemo(ShowBase):
    def __init__(self):
        ...
        #ralphStartPos = LPoint3f(-123.0, -41.0, 4.0)
        ...
        for i in range(1):
            ...
            n = r.getNode(0).solids[0].collision_origin
            g_item[i].setPos(n.getX(), n.getY(), n.getZ())
            self.itemColNode = CollisionNode('CollisionItem_' + str(i))  # 定義名
            self.itemColNode.addSolid(CollisionBox(0, 1, 1, 1))          # 衝突範囲
            self.itemColNp = g_item[i].attachNewNode(self.itemColNode)   # アイテムに追加
            self.itemColNp.show()
